 ...
 O PROMT: **TRACKING COMMIT BRANCH**
 
 ## O Copiloto me retornou:
 
 Branch de rastreamento (ou tracking branch) é um branch local que está conectado a um branch remoto. Isso significa que quando você faz push ou pull nesse branch, ele automaticamente sincroniza com o branch remoto ao qual está conectado1.
